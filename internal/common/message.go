...
type HTTPData struct {
	...
	// BlockedBy, when non-empty, marks a response generated by the agent's
	// route policy engine rather than the backend ("ip_whitelist",
	// "rate_limit", "no_route"). The router renders its branded error page
	// for these instead of passing the body through.
	BlockedBy string `json:"blocked_by,omitempty"`
	// RetryAfter is the Retry-After hint in seconds for rate-limited
	// responses; 0 means none.
